...
class testActivityAddactivity(unittest.TestCase):
    def __init__(self):
        self.url ='Activity/activity/addActivity'
        super().__init__()
        pass
    def diff(self):
        CaseOb = testsGetCase('Activity','activity','addActivity')
        # 拿用例
        cases = CaseOb.getCase()
        self.assertIsNot(cases, 'null', "为空")
        myhttp = testsHttp()
        # 拿token
...
if __name__ == "__main__":
   testOb =testActivityAddactivity()
   testOb.diff()